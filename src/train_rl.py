#!/usr/bin/env python3
"""Train PPO agent for Franka pick-and-place task.

This script trains a PPO agent using Stable-Baselines3 on the Franka pick-and-place
...
def main():
    parser = argparse.ArgumentParser(
        description='Train PPO agent for Franka pick-and-place task',
...
Examples:
  ...
  %(prog)s --headless --bc-warmstart demos/recording.npz --timesteps 1000000
    ...
    # Output arguments
    parser.add_argument('--output', type=str, default='models/ppo_franka.zip',
                        help='Output model path (default: models/ppo_franka.zip)')
    ...
    print("=" * 60)
    print("PPO Training for Franka Pick-and-Place")
    print("=" * 60)
